...
current_slice: Stage 2 fixed Plant, isolated transport, synthetic RT contract, and process entry points implemented
...
next_proof: policy history/reset, exact observation/action fixture, original-deadline faults, and lineage evidence
