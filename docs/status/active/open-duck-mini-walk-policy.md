...
blocker: Stage 0 reference runner produces 0.0031 m against the frozen 0.10 m displacement floor after matching official reset/step and initial phase ordering; pinned reference parity cannot be established without a scope decision
...
next_slice: user decision required to reshape the frozen reference contract or supply the missing canonical runner inputs
