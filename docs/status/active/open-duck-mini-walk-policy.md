...
current_slice: Stage 2 fixed Plant, isolated transport, synthetic RT contract, and process entry points implemented; workspace, clippy, Reachy scenario, and reference/policy/stall launcher smoke gates verified
...
next_slice: Stage 3 Python ONNX policy and fault integration
next_proof: policy history/reset, exact observation/action fixture, original-deadline faults, and lineage evidence through the Rust runtime/RT process path
