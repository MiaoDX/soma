...
last_proven: Rust fmt/tests/clippy, full Python suite (21 passed with plugin autoload disabled), simulation scenario, Rust policy twice, Rust stall expiry, and Python oracle twice pass with external ORT 1.28.0
...
parked: hardware proof remains explicitly out of scope; default pytest is environment-blocked by ROS plugin missing yaml
